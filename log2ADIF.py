...
#        print(bds)
    ...
    bds="<Band:3>00M"  # band not found
    return


# Connect to the database, hardcode to default location
conn = sqlite3.connect('/home/pi/sbitx/data/sbitx.db')
cursor = conn.cursor()
...
with open('/home/pi/sbitx/data/logADIF.adif', 'w') as file:
